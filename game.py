...
# I add 100 line playable adventure game with a dragon and a treasure room. 
# I also added a combat system where the player can attack the dragon and the dragon can attack back.    